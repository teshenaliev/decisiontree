...
function wpfp_widget_init() {
    function wpfp_widget_view($args) {
        ...
        $title = empty($options['widget_title']) ? 'Most Selected Posts' : $options['widget_title'];
        echo $before_widget;
    ...
    ?>
        ...
        <p>
            <label for="wpfp-limit">
                <?php _e('Number of posts to show:'); ?> <input type="text" value="<?php echo $limit; ?>" style="width: 50px; text-align:center;" id="wpfp-limit" name="wpfp-limit" />
            </label>
        </p>
    ...
    wp_register_sidebar_widget('wpfp-most_favorited_posts', 'Most Selected Posts', 'wpfp_widget_view');
    wp_register_widget_control('wpfp-most_favorited_posts', 'Most Selected Posts', 'wpfp_widget_control' );
    ...
    ?>
        ...
        <p>
            <label for="wpfp-uf-limit">
                <?php _e('Number of posts to show:'); ?> <input type="text" value="<?php echo $uf_limit; ?>" style="width: 50px; text-align:center;" id="wpfp-uf-limit" name="wpfp-uf-limit" />
            </label>
        </p>
    ...
    wp_register_sidebar_widget('wpfp-users_favorites','User\'s Selections', 'wpfp_users_favorites_widget_view');
    wp_register_widget_control('wpfp-users_favorites','User\'s Selections', 'wpfp_users_favorites_widget_control' );
}
