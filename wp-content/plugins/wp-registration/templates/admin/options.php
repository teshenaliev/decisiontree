...
$basic_options = array('form-title'	=> array(	'label'		=> __('Signup form title', 'wp-registration'),
					...
					'registration-url'=> array(	'label'		=> __('Registration page URL', 'wp-registration'),
					 							'desc'		=> __('Enter URL of signup page if you created', 'wp-registration'),
					 							'id'			=> 'nm_wpregistration'.'_register_url',
					 							'type'			=> 'text',
					 							'default'		=> '',
					 							'help'			=> __('SignUp page URL: Like http://www.yourdomain.com/signup.', 'wp-registration'),
					 							),
