<?php
/**
 * Zoom Construction Theme Customizer functionality
 *
 * @package WordPress
...
function twentysixteen_custom_header_and_background() {
	...
	/**
	 * Filter the arguments used when adding 'custom-background' support in Zoom Construction Theme.
	 *
	 * @since Zoom Construction Theme 1.0
	 *
	 * @param array $args {
	...
	/**
	 * Filter the arguments used when adding 'custom-header' support in Zoom Construction Theme.
	 *
	 * @since Zoom Construction Theme 1.0
	 *
	 * @param array $args {
...
/**
 * Registers color schemes for Zoom Construction Theme.
 *
...
function twentysixteen_get_color_schemes() {
	/**
	 * Filter the color schemes registered for use with Zoom Construction Theme.
	 *
...
/**
 * Retrieves the current Zoom Construction Theme color scheme.
 *
...
/**
 * Retrieves an array of color scheme choices registered for Zoom Construction Theme.
 *
...
/**
 * Handles sanitization for Zoom Construction Theme color schemes.
 *
